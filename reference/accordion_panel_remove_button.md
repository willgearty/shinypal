...
#>     <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bslib-accordion-panel-2261" aria-expanded="false" aria-controls="bslib-accordion-panel-2261">
#>       <div class="accordion-icon"></div>
#>       <div class="accordion-title">My step</div>
#>     </button>
#>   </div>
#>   <div id="bslib-accordion-panel-2261" class="accordion-collapse collapse">
